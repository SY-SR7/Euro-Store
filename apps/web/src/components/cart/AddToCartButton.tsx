...
export function AddToCartButton({ outOfStock = false, ...item }: Props) {
  ...
  return (
    <button
      ...
      disabled={outOfStock}
      className="w-full rounded-sm bg-[#C9A84C] py-3 text-sm font-semibold text-[#111111] hover:bg-[#D8B95F] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
    >
