...
export function BentoFeatures() {
  ...
  return (
    <section className="relative z-20 w-full bg-background text-text-primary px-6 py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        ...
        >
          ...
          <h3 className="relative z-10 text-2xl font-bold mb-2 text-text-primary">{t('bento1.title')}</h3>
        ...
        >
          ...
          <h3 className="text-lg font-bold mb-2 text-text-primary">{t('bento2.title')}</h3>
        ...
        >
          ...
          <h3 className="text-lg font-bold mb-2 text-text-primary">{t('bento3.title')}</h3>
