...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 flex h-16 items-center justify-around border-t border-white/40 bg-white/60 pb-safe backdrop-blur-2xl backdrop-saturate-150 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] md:hidden">
      {navItems.map((item) => {
