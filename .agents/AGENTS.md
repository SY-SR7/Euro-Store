...
## صلاحيات تلقائية — Auto-Approve Policy
...
> **المالك أعطى موافقة دائمة وشاملة على جميع العمليات داخل هذا المشروع.**
> لا يحتاج الـ Agent لطلب إذن لأي أمر قراءة أو كتابة أو تشغيل داخل:
